...
export default function DonationDetailPage() {
  ...
  const fetchPost = async () => {
    try {
      ...
      if (
        data.post.adoptionForms.some(
          (form: AdoptionForm) => form.userId === localStorage.getItem("userId")
        )
      ) {
        setHasApplied(true);
      }
  ...
  const handleDeleteComment = async (commentId: string) => {
    try {
      ...
      const response = await fetch(
        `/api/users/donation/${id}/comment/${commentId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const acceptedApplication = post.adoptionForms.find(
    ...
    <div className="container mx-auto py-4 px-4 sm:py-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row transition-all">
          ...
          <div className="lg:w-1/2 p-4 sm:p-6">
            ...
            <div className="flex flex-wrap items-center mt-2 text-gray-600 text-sm sm:text-base">
              <span className="mr-2">
                {" "}
                <Cat className="h-4 w-4 mr-1 inline" /> {post.species}
              </span>
            ...
            {acceptedApplication && (
              <div className="mt-4 bg-green-50 p-4 rounded-md border border-green-100">
                ...
                {acceptedApplication.userId === currentUserId ? (
                  ...
                  <p className="text-sm text-green-700 mt-1">
                    This pet has been adopted by another user.
                  </p>
                )}
              </div>
            )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <h2 className="text-lg sm:text-xl font-semibold mb-4">
              Applications ({post._count.adoptionForms})
            </h2>
                    ...
                    {(isPostOwner || form.userId === currentUserId) && (
                      <>
                        ...
                        <div className="flex items-center mt-2 text-xs text-gray-600">
                          ...
                          <span>
                            Meeting: {formatDate(form.meetingSchedule)}
                          </span>
                        </div>
                      </>
                    )}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              pet donation post and remove all related data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
