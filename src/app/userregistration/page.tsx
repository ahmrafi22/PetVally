...
export default function UserRegistration() {
  ...
  return (
    <div className="min-h-screen overflow-hidden flex flex-col bg-gradient-to-tr from-red-200 to-blue-200 px-4 sm:px-6 lg:px-5 xl:px-0">
                  ...
                  <div>
                    <div className="relative">
                      <input
                        ...
                        className="appearance-none rounded-sm relative block w-full px-3 py-3 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-pink-500 focus:border-pink-500 focus:z-10 sm:text-sm"
