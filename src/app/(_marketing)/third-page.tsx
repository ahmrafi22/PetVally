...
export default function ThirdPage() {
  return (
    <div
      className={cn(
        "min-h-screen w-full p-4 md:p-6 overflow-x-hidden overflow-y-auto relative border-b-2  border-black",
        text.className
      )}
    >
      {/* Base gradient background */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0 bg-gradient-to-b from-orange-200"></div>
        ...
        <header className="max-w-7xl mx-auto text-center mb-4">
          <TxtEffct animateOnScroll={true} delay={0.2}>
            <p className="text-sm md:text-base text-gray-700 max-w-3xl mx-auto mb-12 ">
              Your one-stop platform for all pet needs - from shopping to
              adoption, care services to veterinary assistance
            </p>
          </TxtEffct>
        </header>
                  ...
                  <div className="space-y-2 md:space-y-3">
                    <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                      ...
                      <p className="text-gray-700 text-xs md:text-sm mt-1">
                        Share your experience with products and help other pet
                        owners.
                      </p>
                    </div>
                    <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                      ...
                      <p className="text-gray-700 text-xs md:text-sm mt-1">
                        Track your orders in real-time and manage your
                        purchases.
                      </p>
                    </div>
                    <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                      ...
                      <p className="text-gray-700 text-xs md:text-sm mt-1">
                        Fill a lifestyle form to get personalized pet
                        recommendations.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-gray-700 text-xs md:text-sm">
                        Post pets for donation and schedule visits
                      </p>
                    </div>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="grid grid-cols-2 gap-2 md:gap-3 mb-2 md:mb-3">
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col items-center">
                    ...
                    <p className="text-gray-700 text-center text-xs mt-1">
                      Get advice based on text and image inputs
                    </p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col items-center">
                    ...
                    <p className="text-gray-700 text-center text-xs mt-1">
                      Find nearby vets and schedule appointments
                    </p>
                  </div>
                </div>
