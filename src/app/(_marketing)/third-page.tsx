...
export default function ThirdPage() {
  return (
    <div className="min-h-screen w-full p-4 md:p-6 overflow-x-hidden overflow-y-auto relative border-b-2  border-black">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 pb-8">
          ...
          <WobbleCard containerClassName="md:col-span-2 bg-pink-400">
            <div className="flex flex-col h-full">
              <div className="flex items-center gap-3 mb-2 md:mb-0">
                <ShoppingBag className="h-5 w-5 md:h-6 md:w-6 text-black" />
                <h2 className="text-lg md:text-2xl font-bold text-black">Shopping & Pet Adoption</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 flex-grow mt-2">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3 md:p-4 flex flex-col">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-sm md:text-base font-semibold text-black">Pet Store</h3>
                  </div>
                ...
                <div className="space-y-2 md:space-y-3">
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-sm md:text-base font-semibold text-black">Reviews & Ratings</h3>
                    </div>
                  ...
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-sm md:text-base font-semibold text-black">Order Tracking</h3>
                    </div>
                  ...
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-sm md:text-base font-semibold text-black">Pet Matching</h3>
                    </div>
                    <p className="text-gray-700 text-xs md:text-sm mt-1">
          ...
          <WobbleCard containerClassName="bg-blue-400">
            <div className="flex flex-col h-full">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                <Gift className="h-5 w-5 md:h-6 md:w-6 text-black" />
                <h2 className="text-lg md:text-xl font-bold text-black">Pet Donations & Missing Pets</h2>
              </div>
          ...
          <WobbleCard containerClassName="bg-teal-500">
            <div className="flex flex-col h-full">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                <Stethoscope className="h-5 w-5 md:h-6 md:w-6 text-black" />
                <h2 className="text-lg md:text-xl font-bold text-black">Veterinary Services</h2>
              </div>
              <div className="grid grid-cols-2 gap-2 md:gap-3 mb-2 md:mb-3">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col items-center">
                  <Bot className="h-6 w-6 md:h-8 md:w-8 text-black mb-1" />
                  <h3 className="text-sm md:text-base font-semibold text-black text-center">AI Vet Assistant</h3>
                  <p className="text-gray-700 text-center text-xs mt-1">Get advice based on text and image inputs</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col items-center">
                  <Users className="h-6 w-6 md:h-8 md:w-8 text-black mb-1" />
                  <h3 className="text-sm md:text-base font-semibold text-black text-center">Vet Directory</h3>
          ...
          <WobbleCard containerClassName="md:col-span-2 bg-purple-400">
            <div className="flex flex-col h-full py-2 md:py-3">
              <div className="flex items-center gap-2 md:gap-3 mb-2">
                ...
                <h2 className="text-lg md:text-2xl font-bold text-black">Pet Care Jobs & Companion Services</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-3 flex-grow">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-sm md:text-base font-semibold text-black">Job Listings</h3>
                  </div>
                  <p className="text-gray-700 text-xs md:text-sm mb-2">
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-sm md:text-base font-semibold text-black">Pet Companions</h3>
                  </div>
                  <p className="text-gray-700 text-xs md:text-sm mb-2">
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 md:p-3 flex flex-col">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-sm md:text-base font-semibold text-black">Calendar View</h3>
                  </div>
                  <p className="text-gray-700 text-xs md:text-sm mb-2">
